...
\title{Non-algorithmic Capability Gaps for \Cyclus and \Cycamore Transition Analyses }
...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    %------------------------------------------------
    \vspace{1cm}
    \textsc{\LARGE\bfseries UIUC-ARFC-2017-02} % Replace YYYY with the year, NN with report index
    \vspace{0.5cm}
    ...
    {\large November 30, 2017} % Date, change the \today to a set date if you want to be precise
    \vspace{0.5cm}
